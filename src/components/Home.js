...
class Home extends Component {
    ...
    //take the user-entered data and creates a link dynamically from this
    //we navigate to the link by pushing this string into the history
    //object found in the props
    //this.name.value is a ref element specified in the form element
    handleSubmit = (e) => {
        e.preventDefault();
    ...
    render() {
        return (
          <div className="main-content home">
            ...
            {/* Example of using match params to use as filters*/}
            <Link to="teachers/HTML/Tommy-Wingo">Tommy Wingo</Link>
            <hr />
            {/* to access the input element you set refs on the input field using a callback function */}
